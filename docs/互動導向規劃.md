...
動畫時間參考 Google Material motion：桌面轉場應更快，常落在 150-200ms；手機常見轉場約 300ms，但超過 400ms 容易顯得遲滯。本專案先採較保守的短動畫，避免干擾兒童學習。
...
音效規則參考 Material sound 的 informative、honest、reassuring 原則：聲音要提供資訊、符合產品個性，並讓使用者安心。對兒童情境而言，答錯音效必須柔和，不能讓孩子覺得被懲罰。
